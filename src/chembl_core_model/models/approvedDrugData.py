...
class ProductPatents(six.with_metaclass(ChemblModelMetaClass, ChemblCoreAbstractModel)):
    ...
    patent_no = models.CharField(max_length=11, help_text='Patent numbers as submitted by the applicant holder for patents covered by the statutory provisions')
...
class Formulations(six.with_metaclass(ChemblModelMetaClass, ChemblCoreAbstractModel)):
    ...
    ingredient = models.CharField(max_length=200, blank=True, null=True, help_text='Name of the approved ingredient within the product')
    strength = models.CharField(max_length=200, blank=True, null=True, help_text='Dose strength')
