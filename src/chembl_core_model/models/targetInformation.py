...
class TargetType(six.with_metaclass(ChemblModelMetaClass, ChemblCoreAbstractModel)):
    ...
    target_type = ChemblCharField(primary_key=True, max_length=30, help_text='Target type (as used in target dictionary)')
    target_desc = ChemblCharField(max_length=250, blank=True, null=True, help_text='Description of target type')
    parent_type = ChemblCharField(max_length=25, blank=True, null=True, help_text="Higher level classification of target_type, allowing grouping of e.g., all 'PROTEIN' targets, all 'NON-MOLECULAR' targets etc.")
...
class OrganismClass(six.with_metaclass(ChemblModelMetaClass, ChemblCoreAbstractModel)):
    ...
    l1 = ChemblCharField(max_length=200, blank=True, null=True, help_text='Highest level classification (e.g., Eukaryotes, Bacteria, Fungi etc)')
    l2 = ChemblCharField(max_length=200, blank=True, null=True, help_text='Second level classification')
    l3 = ChemblCharField(max_length=200, blank=True, null=True, help_text='Third level classification')
...
class ProteinFamilyClassification(six.with_metaclass(ChemblModelMetaClass, ChemblCoreAbstractModel)):
    ...
    protein_class_desc = ChemblCharField(max_length=810, unique=True, help_text='Concatenated description of each classification for searching purposes etc.')
    l1 = ChemblCharField(max_length=100, help_text='First level classification (e.g., Enzyme, Transporter, Ion Channel).')
    l2 = ChemblCharField(max_length=100, blank=True, null=True, help_text='Second level classification.')
    l3 = ChemblCharField(max_length=100, blank=True, null=True, help_text='Third level classification.')
    l4 = ChemblCharField(max_length=100, blank=True, null=True, help_text='Fourth level classification.')
    l5 = ChemblCharField(max_length=100, blank=True, null=True, help_text='Fifth level classification.')
    l6 = ChemblCharField(max_length=100, blank=True, null=True, help_text='Sixth level classification.')
    l7 = ChemblCharField(max_length=100, blank=True, null=True, help_text='Seventh level classification.')
    l8 = ChemblCharField(max_length=100, blank=True, null=True, help_text='Eighth level classification.')
...
class ProteinClassification(six.with_metaclass(ChemblModelMetaClass, ChemblCoreAbstractModel)):
    ...
    pref_name = ChemblCharField(max_length=500, blank=True, null=True, help_text='Preferred/full name for this protein family.')
    short_name = ChemblCharField(max_length=50, blank=True, null=True, help_text='Short/abbreviated name for this protein family (not necessarily unique).')
    protein_class_desc = ChemblCharField(max_length=410, help_text='Concatenated description of each classification for searching purposes etc.')
    definition = ChemblCharField(max_length=4000, blank=True, null=True, help_text='Definition of the protein family.')
...
class GoClassification(six.with_metaclass(ChemblModelMetaClass, ChemblCoreAbstractModel)):
    ...
    go_id = ChemblCharField(primary_key=True, max_length=10, help_text='Primary key. Gene Ontology identifier for the GO slim term')
    parent_go_id = ChemblCharField(max_length=10, blank=True, null=True, help_text='Gene Ontology identifier for the parent of this GO term in the ChEMBL Drug Target GO slim')
    pref_name = ChemblCharField(max_length=200, blank=True, null=True, help_text='Gene Ontology name')
    ...
    aspect = ChemblCharField(max_length=1, blank=True, null=True, choices=ASPECT_CHOICES, help_text='Indicates which aspect of the Gene Ontology the term belongs to (F = molecular function, P = biological process, C = cellular component)')
    path = ChemblCharField(max_length=1000, blank=True, null=True, help_text='Indicates the full path to this term in the GO slim')
...
class ComponentSequences(six.with_metaclass(ChemblModelMetaClass, ChemblCoreAbstractModel)):
    ...
    component_type = ChemblCharField(max_length=50, blank=True, null=True, choices=COMPONENT_TYPE_CHOICES, help_text="Type of molecular component represented (e.g., 'PROTEIN','DNA','RNA').")
    accession = ChemblCharField(max_length=25, unique=True, blank=True, null=True, help_text='Accession for the sequence in the source database from which it was taken (e.g., UniProt accession for proteins).')
    ...
    description = ChemblCharField(max_length=200, blank=True, null=True, help_text='Description/name for the molecular component, usually taken from the source sequence database.')
    ...
    organism = ChemblCharField(max_length=150, blank=True, null=True, help_text='Name of the organism the sequence comes from.')
    db_source = ChemblCharField(max_length=25, blank=True, null=True, choices=DB_SOURCE_CHOICES, help_text='The name of the source sequence database from which sequences/accessions are taken. For UniProt proteins, this field indicates whether the sequence is from SWISS-PROT or TREMBL.')
    db_version = ChemblCharField(max_length=10, blank=True, null=True, help_text='The version of the source sequence database from which sequences/accession were last updated.')
...
class VariantSequences(six.with_metaclass(ChemblModelMetaClass, ChemblCoreAbstractModel)):
    ...
    mutation = ChemblCharField(max_length=2000, blank=True, null=True, help_text='Details of variant(s) used, with residue positions adjusted to match provided sequence.')
    accession = ChemblCharField(max_length=25, blank=True, null=True, help_text='UniProt accesion for the representative sequence used as the base sequence (without variation).')
    ...
    organism = ChemblCharField(max_length=200, blank=True, null=True, help_text='Organism from which the sequence was obtained.')
...
class CellDictionary(six.with_metaclass(ChemblModelMetaClass, ChemblCoreAbstractModel)):
    ...
    cell_name = ChemblCharField(max_length=50, help_text='Name of each cell line (as used in the target_dicitonary pref_name).')
    cell_description = ChemblCharField(max_length=200, blank=True, null=True, help_text='Longer description (where available) of the cell line.')
    cell_source_tissue = ChemblCharField(max_length=50, blank=True, null=True, help_text='Tissue from which the cell line is derived, where known.')
    cell_source_organism = ChemblCharField(max_length=150, blank=True, null=True, help_text='Name of organism from which the cell line is derived.')
    ...
    clo_id = ChemblCharField(max_length=11, blank=True, null=True, help_text='ID for the corresponding cell line in Cell Line Ontology')
    efo_id = ChemblCharField(max_length=12, blank=True, null=True, help_text='ID for the corresponding cell line in Experimental Factory Ontology')
