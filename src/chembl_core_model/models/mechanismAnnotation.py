...
class ActionType(six.with_metaclass(ChemblModelMetaClass, ChemblCoreAbstractModel)):
    ...
    action_type = ChemblCharField(primary_key=True, max_length=50, help_text='Primary key. Type of action of the drug e.g., agonist, antagonist')
    description = ChemblCharField(max_length=200, help_text='Description of how the action type is used')
    parent_type = ChemblCharField(max_length=50, blank=True, null=True, help_text='Higher-level grouping of action types e.g., positive vs negative action')
...
class DrugMechanism(six.with_metaclass(ChemblModelMetaClass, ChemblCoreAbstractModel)):
    ...
    mechanism_comment = ChemblCharField(max_length=500, blank=True, null=True, help_text='Additional comments regarding the mechanism of action')
    selectivity_comment = ChemblCharField(max_length=100, blank=True, null=True, help_text='Additional comments regarding the selectivity of the drug')
    binding_site_comment = ChemblCharField(max_length=100, blank=True, null=True, help_text='Additional comments regarding the binding site of the drug')
    ...
    curation_status = ChemblCharField(max_length=10, default='PARTIAL', choices=CURATION_STATUS_CHOICES, help_text='Show whether the curation for this row is complete')
...
class DrugIndication(six.with_metaclass(ChemblModelMetaClass, ChemblCoreAbstractModel)):
    ...
    efo_id = ChemblCharField(max_length=20, blank=True, null=True, help_text='Experimental Factor Ontology (EFO) disease identifier corresponding to the indication')
    efo_term = ChemblCharField(max_length=200, blank=True, null=True, help_text='Experimental Factor Ontology term for the EFO ID')
