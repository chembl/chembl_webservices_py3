...
class DatabaseWrapper(BaseDatabaseWrapper):
    ...
    _standard_pattern_ops = {k: "LIKE TRANSLATE( " + v + " USING NCHAR_CS)"
                             ...
                             for k, v in list(_pattern_ops.items())}
...
class FormatStylePlaceholderCursor(object):
    ...
    def _format_params(self, params):
        try:
            return {k: OracleParam(v, self, True) for k, v in list(params.items())}
        except AttributeError:
    ...
    def _param_generator(self, params):
        ...
        if hasattr(params, 'items'):
            return {k: v.force_bytes for k, v in list(params.items())}
        else:
    ...
    def _fix_for_params(self, query, params):
        ...
        if params is None:
            ...
            args = {k: ":%s" % k for k in list(params.keys())}
